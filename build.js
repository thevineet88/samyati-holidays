  ...
  const itinerary = (pkg.itinerary || [])
    .map((day) => {
      const meals = day.meals
        ...
        : '';
      const pinColor = day.day === 1 ? 'var(--color-navy)' : '#9CA3AF';
      return `<div class="accordion-item">
      <button class="accordion-btn" aria-expanded="false" aria-controls="day-${day.day}">
        <div class="flex items-center gap-2.5">
          <div class="day-pin">
            <svg width="28" height="36" viewBox="0 0 28 36" fill="none">
              <path d="M14 34C14 34 25 23.5 25 15.5C25 8.5 20.5 3.5 14 3.5C7.5 3.5 3 8.5 3 15.5C3 23.5 14 34 14 34Z" fill="${pinColor}" stroke="white" stroke-width="2"/>
              <circle cx="14" cy="15" r="5" fill="white" stroke="${pinColor}" stroke-width="2"/>
            </svg>
          </div>
          <span class="font-poppins font-semibold text-[var(--color-navy)] text-[0.95rem]">Day ${day.day}, ${h(day.title)}</span>
        </div>
